...
/*   Updated: 2021/06/14 18:42:28 by akhastaf         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_opr(t_checker *c, char *opr)
{
	if (!(!ft_strcmp(opr, "sa") || !ft_strcmp(opr, "sb")
			|| !ft_strcmp(opr, "ss") || !ft_strcmp(opr, "pa")
			|| !ft_strcmp(opr, "pb") || !ft_strcmp(opr, "ra")
			|| !ft_strcmp(opr, "rb") || !ft_strcmp(opr, "rr")
			|| !ft_strcmp(opr, "rra") || !ft_strcmp(opr, "rrb")
			|| !ft_strcmp(opr, "rrr")))
	{
